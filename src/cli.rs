...
#[derive(Parser, Debug)]
#[command(version, about, verbatim_doc_comment, arg_required_else_help = false)]
...
pub struct Cli {
    ...
    #[arg(short = 'r', long = "requirement", value_parser = VersionReq::parse)]
